...
@ 
The following show method eats up a lot of RAM!
<<show, eval = FALSE, echo = TRUE>>=
...
@ 
<<save-geno>>=
  save( geno.mat, file = paste0("/home/sgy/jhsph/targeted-sequencing/repo/vcf2R/data/", locus, "-european.geno.RData" ) )
@ 
<<common>>=
